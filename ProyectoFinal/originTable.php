    ...
    <?php 
        ...
        if(isset($_GET['aksi']) == 'delete'){
            ...
            if(mysqli_num_rows($cek) == 0){
                ...
                if($delete){
                    header("Location: originTable.php");die();
                }
                else{
        ...
        <div class="content">
            ...
            <?php 
                while($row =mysqli_fetch_array($result)){
                    echo" 
                    <tr> 
                        <td>".$row['Codigo_origen']."</td> 
                        <td>".$row['Nombre']."</td> 
                        <td>".$row['Otros_datos']."</td> 
                        <td> <a class='btn btn-sm btn-primary' href='originEdit.php?nik=".$row['Codigo_origen']."'>Editar datos</a></td>
                        <td> <a class='btn btn-sm btn-danger' href='originTable.php?aksi=delete&nik=".$row['Codigo_origen']."' title='Eliminar' onclick='return confirm(\"Estas seguro de borrar los datos de ".$row['Nombre']."?\")'>Eliminar</a></td>
                    </tr>";
                }
            ?>
